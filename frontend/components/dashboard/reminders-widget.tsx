...
export function RemindersWidget() {
  ...
  return (
    <Card className="h-[236px] relative">
      <CardHeader>
        <CardTitle>Напоминания</CardTitle>
      </CardHeader>
      <CardContent className="flex flex-col gap-0 pb-[59px]">
      ...
      <div className="absolute bottom-[19px] left-[19px] right-[19px] flex gap-[10px]">
        <button className="h-[30px] px-[14px] bg-white border border-[#d4d4d4] rounded-[8px] flex items-center gap-[8px]">
        ...
        <button className="h-[30px] px-[14px] bg-[#1f1f1f] rounded-[8px] flex items-center gap-[8px] ml-auto">
