...
- ✅ Полное исправление дизайна дашборда (px-perfect)
- ✅ Страница заказов с фильтрацией и поиском
- ✅ Страница каталога товаров (grid/list view)
...
### Следующие задачи
- [ ] Интеграция frontend с backend API
- [ ] Аутентификация на frontend (JWT tokens)
- [ ] Страница деталей заказа
- [ ] Страница профиля компании
- [ ] Real-time обновления (WebSocket для чатов)
